...
/**
 * {@code ProspectiveSearchServiceComponent} is a Gig component which is 
 * representing Google App Engine {@code ProspectiveSearchService}.
 * 
...
public class ProspectiveSearchServiceComponent extends Component<ProspectiveSearchService> {
	...
	/** Returns {@code ProspectiveSearchService}. */
	@Override
	public ProspectiveSearchService instance() {
		return prospectiveSearchService;
	}
