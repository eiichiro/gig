...
/**
 * {@code MemcacheServiceComponent} is a Gig component which is representing 
 * Google App Engine {@code MemcacheService}.
 * 
...
public class MemcacheServiceComponent extends Component<MemcacheService> {
	...
	/** Returns {@code MemcacheService}. */
	@Override
	public MemcacheService instance() {
