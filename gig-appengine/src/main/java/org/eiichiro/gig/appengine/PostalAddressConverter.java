 ...
 */
public class PostalAddressConverter extends AbstractConverter {
	...
	protected Object convertToType(Class type, Object value) throws Throwable {
		return new PostalAddress(value.toString());
	}

	/**
	 * Returns {@code com.google.appengine.api.datastore.PostalAddress} as the default 
	 * type this converter handles.
	 * 
	 * @see org.apache.commons.beanutils.converters.AbstractConverter#getDefaultType()
	 */
	@Override
	protected Class<PostalAddress> getDefaultType() {
		return PostalAddress.class;
	}
	
	/**
	 * Returns {@code com.google.appengine.api.datastore.PostalAddress} value as 
