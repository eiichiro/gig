...
/**
 * {@code MailServiceComponent} is a Gig component which is representing 
 * Google App Engine {@code MailService}.
 * 
...
public class MailServiceComponent extends Component<MailService> {
	...
	/** Returns {@code MailService}. */
	@Override
	public MailService instance() {
		return mailService;
	}
