...
/**
 * {@code AsyncMemcacheServiceComponent} is a Gig component which is 
 * representing Google App Engine {@code AsyncMemcacheService}.
 * 
...
public class AsyncMemcacheServiceComponent extends Component<AsyncMemcacheService> {
	...
	/** Returns {@code AsyncMemcacheService}. */
	@Override
	public AsyncMemcacheService instance() {
