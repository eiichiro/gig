...
/**
 * {@code HerokuPostgresJPAEntityManagerComponent} is a representing JPA 2.0 
...
public class HerokuPostgresJPAEntityManagerComponent extends Component<EntityManager> {
	...
	@Inject @Heroku @Required private EntityManagerFactory factory;
	
	/**
	 * Lifecycle callback to assemble this instance with the {@code EntityManager} 
	 * {@link HerokuPostgresJPAEntityManagerFactoryComponent} returns.
	 */
	@Activated
	 ...
	 * {@code HerokuPostgresJPAEntityManagerFactoryComponent} could not establish the connection 
