...
public class NewWebEndpointWizardPage extends NewTypeWizardPage {

	private SelectionButtonDialogFieldGroup stubsFieldGroup;
	
	public NewWebEndpointWizardPage() {
		super(true, "NewWebEndpointWizardPage");
		setTitle("Web Endpoint");
		setDescription("Create a new Web endpoint class.");
		String[] stubTexts = {
	...
	protected String constructCUContent(ICompilationUnit cu,
		...
		return super.constructCUContent(cu, "@Endpoint" + lineDelimiter + "@Name(\"" + name + "\")" + lineDelimiter + typeContent, lineDelimiter);
	}
	...
	protected void createTypeMembers(IType newType, ImportsManager imports,
		...
		imports.addImport("org.eiichiro.bootleg.annotation.Endpoint");
