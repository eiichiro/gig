...
public class NewComponentWrapperWizardPage extends NewTypeWizardPage {

	private SelectionButtonDialogFieldGroup stubsFieldGroup;
	
	public NewComponentWrapperWizardPage() {
		super(true, "NewComponentWrapperWizardPage");
		setTitle("Component Representation");
		setDescription("Create a new Component wrapper class.");
		String[] stubTexts = {
	...
	public void init(IStructuredSelection selection) {
		...
		setSuperClass("org.eiichiro.jaguar.Component", true);
